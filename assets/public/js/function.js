...
function switching(element, e, id) {
    ...
    if ($(element).is(':checked')) {
        var value = 'Y';
        var type = false;
        var message = 'Anda yakin akan membuka akses pada data ini? Selanjutnya data akan bisa mengakses sistem';
    } else {
        var value = 'N';
         var type = "textarea";
        var message = 'Anda yakin akan menutup akses pada data ini? data tidak akan bisa mengakses sistem';
    }
    Swal.fire({
        text: message,
        icon: icon,
        ...
        inputPlaceholder: 'Cantumkan alasan mematikan sistem',
        showCancelButton: true,
        buttonsStyling: !1,
        confirmButtonText: "Lanjutkan",
        customClass: {
